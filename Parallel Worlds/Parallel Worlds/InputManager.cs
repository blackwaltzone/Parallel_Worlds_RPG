...
namespace Parallel_Worlds
{
    ...
    public static class InputManager
    {
        ...
        private static readonly string[] actionNames = 
            {
                ...
                "Weapon 1",
                "Weapon 2",
                "Select Spell / Page Screen Left",
                "Cast Spell / Page Screen Right",
                "Move Character - Up",
                "Move Character - Down",
                "Move Character - Left",
        ...
        private static void ResetActionMaps()
        {
            ...
            actionMaps[(int)Action.Select] = new ActionMap();
            actionMaps[(int)Action.Select].keyboardKeys.Add(
                Keys.Enter);
            actionMaps[(int)Action.Select].gamePadButtons.Add(
                GamePadButtons.A);
            ...
            actionMaps[(int)Action.Exit].keyboardKeys.Add(
                Keys.Escape);
            actionMaps[(int)Action.Exit].gamePadButtons.Add(
                GamePadButtons.Back);

            actionMaps[(int)Action.Action] = new ActionMap();
            actionMaps[(int)Action.Action].keyboardKeys.Add(
                Keys.Space);
            actionMaps[(int)Action.Action].gamePadButtons.Add(
                GamePadButtons.X);

            actionMaps[(int)Action.Weapon1] = new ActionMap();
            actionMaps[(int)Action.Weapon1].keyboardKeys.Add(
                Keys.S);
            actionMaps[(int)Action.Weapon1].gamePadButtons.Add(
                GamePadButtons.A);

            actionMaps[(int)Action.Weapon2] = new ActionMap();
            actionMaps[(int)Action.Weapon2].keyboardKeys.Add(
                Keys.D);
            actionMaps[(int)Action.Weapon2].gamePadButtons.Add(
                GamePadButtons.B);

            actionMaps[(int)Action.Attack] = new ActionMap();
            actionMaps[(int)Action.Attack].keyboardKeys.Add(
                Keys.RightControl);
            actionMaps[(int)Action.Attack].gamePadButtons.Add(
                GamePadButtons.RightTrigger);

            actionMaps[(int)Action.Defend] = new ActionMap();
            actionMaps[(int)Action.Defend].keyboardKeys.Add(
                Keys.LeftControl);
            actionMaps[(int)Action.Defend].gamePadButtons.Add(
